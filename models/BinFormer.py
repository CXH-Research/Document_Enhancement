...
class ViT(nn.Module):
    def __init__(self, *, image_size=256, patch_size=16, word_size=8, num_classes=1000, dim, depth, heads, mlp_dim=2048, pool = 'cls', channels = 1, dim_head = 64, dropout = 0., emb_dropout = 0., transformer = None, t2t_layers = ((7, 4), (3, 2), (3, 2))):
        super().__init__()
        layers = []
        layer_dim = channels
